...
export PIGEN_DOCKER_OPTS="${PIGEN_DOCKER_OPTS:-} \
  ...
  -e AIRGAP_PLATFORM_REPO=${AIRGAP_PLATFORM_REPO} \
  -e AIRGAP_PLATFORM_ARCH=${AIRGAP_PLATFORM_ARCH} \
  -e AIRGAP_PLATFORM_CHANNEL=${AIRGAP_PLATFORM_CHANNEL} \
  -e AIRGAP_PLATFORM_REF=${AIRGAP_PLATFORM_REF} \
  -e AIRGAP_PLATFORM_CATALOG_ENABLED=${AIRGAP_PLATFORM_CATALOG_ENABLED} \
  -e AIRGAP_PLATFORM_CATALOG_TAG=${AIRGAP_PLATFORM_CATALOG_TAG} \
