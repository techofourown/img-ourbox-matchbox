...
- Platform inputs: **approved in `sw-ourbox-os/release/approved-upstream-inputs.json`** and currently materialized via transitional generated `release/official-inputs.env` for the official candidate build
