...
- Generated resolution record in this repo:
  - `release/official-inputs.env` (transitional compatibility surface for the
...
`release/official-inputs.env` should be treated as generated compatibility
output, not as the normative approval or control plane.
